        ...
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" x-data>
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3">
                    ...
                    <!-- Commodity Selection -->
                    <div class="mb-6">
                        <label for="upc_commodity"
                            class="block text-sm font-medium text-gray-700 mb-2">Commodity</label>
                            ...
                            <div x-show="$wire.isPublic" x-transition>
                                ...
                                <div class="flex justify-center">
                                    <div class="text-center">
                                        ...
                                        <div
                                            class="inline-block p-3 bg-white border border-gray-200 rounded-lg shadow-sm">
