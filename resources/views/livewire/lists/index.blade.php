                ...
                <div class="flex justify-between items-start">
                    <a href="{{ route('lists.show', $list) }}" class="flex-1 min-w-0 pr-3">
                        <div class="flex justify-between items-baseline">
                            ...
                            <span class="text-gray-600 text-sm ml-2 flex-shrink-0">{{ $list->listItems->count() }}
                                items</span>
                        </div>
                    </a>
                        ...
                        <div class="space-y-4">
                            <div>
                                <p class="text-sm text-gray-600 mb-4">
                                    Publishing "<span class="font-medium"
                                        x-text="$wire.listToPublish ? $wire.listToPublish.name : ''"></span>" to the
                                    public marketplace will allow other users to discover and copy your list.
                                </p>
                            </div>
                ...
                <div class="px-6 py-4">
                    <div class="space-y-3">
                        <p class="text-sm text-gray-500">
                            ...
                            <span class="font-medium text-gray-900"
                                x-text="$wire.listToUnpublish ? $wire.listToUnpublish.name : ''"></span>
